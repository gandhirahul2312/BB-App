...
*/
    ...
    init: function () {
        ...
        if (this.score !== 1) {
            ...
            div.innerHTML     = '';
            div.innerHTML    += 'It appears your browser does not support <b>' + this.fail + '</b> of the CSS3 properties used by this app. Please use a <b>WebKit-based</b>  PlayBook Browser.';
